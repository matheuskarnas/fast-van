...
export default function CadastroDono() {
  ...
  async function handleCadastro() {
    if (!nome.trim() || !email.trim() || !senha.trim() || !cnh.trim()) {
    ...
    setLoading(true);
    try {
      await signUp(email.trim(), senha, nome.trim(), ['dono'], { cnh: cnh.trim() });
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <View style={styles.roleBadge}>
            <Text style={styles.roleText}>DONO DE VAN</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  roleBadge: {
    ...
    backgroundColor: '#EBF0F8', borderRadius: 6,
    paddingHorizontal: 10, paddingVertical: 4
  },
  roleText: { fontSize: 12, fontWeight: '700', color: '#1A3C6E', letterSpacing: 1 },
  form: { gap: 14 },
  btnPrimary: {
